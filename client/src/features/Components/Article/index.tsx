...
export default function Article() {
  return (
    <article className="mx-auto max-w-2xl space-y-12 px-6 py-24 dark:dark:bg-gray-800 dark:dark:text-gray-50">
      ...
      <div className="border-t pt-12 dark:dark:border-gray-700">
        ...
        <div className="align-center flex justify-center space-x-4 pt-4">
          <a
            ...
            href="#"
            aria-label="GitHub"
            className="rounded-md p-2 dark:dark:text-gray-100 hover:dark:dark:text-violet-400"
          >
            <svg
              viewBox="0 0 496 512"
